...
-- AlterTable
ALTER TABLE "SmartWallet" ADD COLUMN "userId" TEXT;
...
-- CreateIndex
CREATE INDEX "SmartWallet_userId_idx" ON "SmartWallet"("userId");

-- CreateIndex
CREATE INDEX "Transaction_userId_idx" ON "Transaction"("userId");

-- AddForeignKey
ALTER TABLE "SmartWallet" ADD CONSTRAINT "SmartWallet_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
